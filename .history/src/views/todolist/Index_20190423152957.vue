<template lang="pug">
  .main-container(v-cloak)
    ApiForm
    div
      input.todo-input(type='text', placeholder='Что должно быть сделано?', v-model='firstTodo')
      button.btn(v-on:click='addNewTodo' v-on:keyup.enter="addNewTodo_enter") Добавить В TODO
