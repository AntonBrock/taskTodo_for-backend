...
export default {
  ...
  created(){
    this.a = localStorage.getItem('todos', JSON.stringify(this.getTodos))
   this.a = localStorage.getItem('todos',JSON.parse(this.getTodos));
  },
  computed: {
    ...mapGetters({
  ...
  methods: {
    ...
    updateTodos(url) {
      ...
      if(this.url >= 2){ 
        ...
        alert(this.a)
      // let a = localStorage.getItem('todos', JSON.stringify(this.getTodos)) //тут вызов из LS
