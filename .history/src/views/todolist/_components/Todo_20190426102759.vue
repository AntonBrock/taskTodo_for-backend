...
export default {
  ...
  methods: {
    ...
    completeTodo(todo) {
      ...
      localStorage.setItem('todos', JSON.stringify(this.getTodos)) //завершенно 
    ...
    checkIt(todo) {
      ...
      .catch(() => {
       ...
       localStorage.setItem('todos', JSON.stringify(this.getTodos)) // авто-создание
    },
    removeItem(index) {
      ...
      // this.newBd = JSON.parse(localStorage.getItem('todos'))
      // this.newBd.splice(index, 1)
