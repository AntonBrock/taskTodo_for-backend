...
// - при кнопке очистить все (как в action залить)
// - при выборе "авто-создание" - в LS правильно, а при обновление - нет
// - каждые 5сек запрос (какой запрос хз)
// 
</script>
